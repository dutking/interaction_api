const db = [
    ...
    // CASE
    {
        ...
        fb: {
            passed: '<p>Поздравляем! Вы успешно проработали все кейсы.</p> <p>Чтобы перейти к финальному тестированию, нажмите кнопку «Далее».</p> <p>Желаем удачи!</p>',
            failed: ''
        }
    },
    // SURVEY
    ...
    },
    {
        ...
        "instruction": ["Настройте ленту главного меню таким образом, чтобы она автоматически скрывалась.", "", "Настройте ленту главного меню таким образом, чтобы показывались только вкладки.", "", "Настройте ленту таким образом, чтобы показывались вкладки и команды.", "", "<h2>Вы отлично справились с заданием!<h2>"],
        "instructionPosition": [
            ["cm", "center"],
            ["cm", "center"],
            ["cm", "center"],
