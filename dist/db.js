    ...
    iterables: [
      {
        id: 't0',
        text:
          'Вылет задерживается по независящим от перевозчика причинам_(пусто,зпт*) началась сильная гроза.',
      ...
      },
      {
        id: 't4',
        text:
          'В_(слитно,дефис,раздельно*)течени_(и,е*) недели необходимо отчитаться по работе д_(и,е*)партаментов за третий квартал.',
        tip: 'Производный предлог.',
        fb: {
          correct:
            '«В течение» – производный предлог, за ним следует слово со значением времени.',
