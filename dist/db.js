const db = [
    ...
    },
    {
        ...
        "instruction": ["Настройте ленту главного меню таким образом, чтобы она автоматически скрывалась.", "", "Настройте ленту главного меню таким образом, чтобы показывались только вкладки.", "", "Настройте ленту таким образом, чтобы показывались вкладки и команды.", ""],
        "instructionPosition": [
            ["cm", "center"],
            ["cm", "center"],
            ["cm", "center"],
